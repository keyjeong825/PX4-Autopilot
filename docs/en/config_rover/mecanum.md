...
Successive steps enable [drive modes](../flight_modes_rover/manual.md) with more autopilot support and features.
...
Yaw rate can be directly mapped to a speed difference between the right and left wheels:
...
- $w_t:$ Wheel track ([RD_WHEEL_TRACK](#RD_WHEEL_TRACK)),
...
5. (Optional) [RO_YAW_ACCEL_LIM](#RO_YAW_ACCEL_LIM) and [RO_YAW_DECEL_LIM](#RO_YAW_DECEL_LIM) [deg/s^2]: This is the maximum yaw acceleration and deceleration you want to allow for your rover.
   ...
   1. Put the rover into [Manual mode](../flight_modes_rover/manual.md#manual-mode).
...
In [auto modes](../flight_modes_rover/auto.md#mission-mode) the autopilot takes over navigation tasks using the following control architecture:
...
| <a id="RM_COURSE_CTL_TH"></a>[RM_COURSE_CTL_TH](../advanced_config/parameter_reference.md#RM_COURSE_CTL_TH) | Threshold to update course control in manual position mode | deg  |

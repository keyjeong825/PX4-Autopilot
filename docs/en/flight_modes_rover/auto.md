...
For the tuning process see the configuration for Auto modes: [Ackermann](../config_rover/ackermann.md#auto-modes), [Differential](../config_rover/differential.md#auto-modes) and [Mecanum](../config_rover/mecanum.md#auto-modes).
...
The desired path is tracked using the pure pursuit algorithm.
